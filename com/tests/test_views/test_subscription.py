...
from com.tests.base import BaseCommentMixinTest
from com.views import BaseToggleFollowView
from com.messages import FollowError, EmailError
from com.models import Follower
...
class BaseToggleFollowViewTest(BaseCommentMixinTest):
    def setUp(self):
        ...
        self.toggle_follow_url = self.get_url(
            reverse('toggle-subscription'), app_name='comment', model_name='comment', model_id=self.comment.id
        )
