$(function () {
    ...
    // view exam_suggestion
    $("#exam_suggestion-table").on("click", ".js-view-exam_suggestion", loadForm);
    $("#modal-exam_suggestion").on("submit", ".js-exam_suggestion-view-form", saveForm);
