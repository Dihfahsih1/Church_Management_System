...
url(r'^Archives/Other-Sources/', views.donationsarchivessearch,
        name='donationsarchivessearch'),
...
url(r'^Un-Archive/Church-Member/(?P<pk>\d+)',
        views.unarchive_member, name='un-archive-member'),
