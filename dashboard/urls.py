...
url(r'^Individual-offerings-report', views.individual_offerings, name='individual-offering'),

url(r'^update-individual-offerings/(?P<pk>\d+)', views.edit_individual_offerings,name='edit_individual_offerings'),
...
#rest framework urls
path('api/v1/members-list', views.uccbwaise_members_api),
path('api/v1/revenues-list', views.revenues_api),
