...
class ExpendituresForm(forms.ModelForm):
    class Meta:
        model=Expenditures
        fields=('Notes','Member_Name','Other_Expenditure','Reason_filtering','Archived_Status','Date','Payment_Made_To','Main_Expense_Reason','General_Expenses_Reason','Petty_Cash_Reason','Amount')
        widgets = {
            'Date': DatePickerInput(),
...
class MembersForm(forms.ModelForm):
    class Meta:
        model= Members
        fields = ('Archived_Status','More_Info','Is_View_on_Web','Group','Initials','First_Name','Second_Name','Telephone','Residence','Gender', 'Home_Cell','Photo','Marital_Status','Marriage_Kind',
